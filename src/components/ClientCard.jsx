  ...
  return (
    <div className="bg-gray-800 text-gray-100 shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-200">
      <div className="bg-gray-700 p-6">
        <h2 className="text-2xl font-semibold text-pink-400 mb-2">{client.name}</h2>
        ...
        <div className="mt-4 flex justify-between space-x-2">
          <button
            ...
            className="bg-gray-900 text-white px-4 py-2 rounded hover:bg-gray-700 transition-colors duration-200"
          >
            Edit
          </button>
          <button
